...
<body>	<table>
		<tr><th style='width:10%'> Mã số</th><th style='width:20%'>Ngày mượn</th><th style='width:20%'>Tình trạng</th><th style='width:28%'>Ngày đăng kí</th><th>Người mượn</th><th style='width:9%'></th></tr>
<?php 
		if($_POST['request']){
			$dk=$_POST['request'];
		
		$result=mysql_query("select MaDK, NgayDk, NgayMuon, Tinhtrang, MaSo from phieudk where MaSo='$dk' order by NgayDk ASC", $cn);
