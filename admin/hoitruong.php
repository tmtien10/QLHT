...
<script language="javascript">
		...
		$("#addnew").on('click', function(){
            ...
            $.ajax(
            {
                ...
                type:'POST',
                data: {maHT:maHT, tenHT:tenHT, act:act, succhua:succhua, diadiem:diadiem},                
...
<div class="sidenav">
 ...
 <div class="active">     <a href="hoitruong.php">Hội trường</a></div>
...
<button class="dropdown-btn"> Thống kê
  ...
  <div class="dropdown-container">
	...
	<p style="font-size:28px;color:#000; padding-left:140px;">HỘI TRƯỜNG</p>
    <div class="main">
			<div id="menuh">
  ...
  <input type="text" class="form-control" id='search' style="width:200px"><span class="input-group-addon" ><i class="glyphicon glyphicon-search"></i></span>
   ...
   <br />
   <hr />
     <div id="formmau" class="form-control" style="height:150px">
     		<table>
                <tr  ><td>	Mã hội trường </td><td><input type="text" id="ma" style="margin-top:20px" class="form-control"/></td>

            		<td>Tên hội trường	</td><td><input type="text"  id="ten" style="width:250px;margin-top:20px"class="form-control"  /></td></tr>
                 <tr><td>   Sức chứa</td><td><input type="text" id="succhua" class="form-control" /></td>

            		<td>Địa điểm	</td><td><input type="text"  id="diadiem" style="width:250px;margin-top:20px" class="form-control"/></td></tr>

          
          <tr><td colspan="2"><center> <button class="btn btn-primary" id="addnew" >OK</button>
        	 <button class="btn btn-default" id="cloupd" >Đóng</button></center><div class='text-warning'></div></td></tr>
</table>
   ...
   <hr />
	...
	<?php 
		...
		$result=mysql_query("select * from hoitruong", $cn);
		     echo"<tr><th style='width:30%'> Mã HT</th><th style='width:30%'>Tên HT</th><th>Số chỗ</th><th>Địa điểm</th><th style='width:10%'></th></tr>";
		...
		while($row=mysql_fetch_array($result)){
				...
				echo "<td><button type='submit' class='btn btn-success'  value='".$row['MaHT']."'><i class=' glyphicon glyphicon-pencil'style='color: white;'></i></button> <button type='submit' class='btn btn-danger' value=".$row['MaHT']." id='del'><i class='glyphicon glyphicon-trash'></i></button>
				</td></tr>";
