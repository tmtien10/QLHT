...
<div class="sidenav">
 <center><p style="color:#CCC; font-size:18px"> Chào, <?php echo $_SESSION["username"];?><br />
  ...
  <div class="active" > <a href="nganh.php">Ngành</a></div>
...
<button class="dropdown-btn"> Thống kê
...
</div>	<p style="font-size:28px;color:#000; padding-left:140px;"> NGÀNH</p>
    <div class="main">
  ...
  <input type="text" class="form-control" id='search' style="width:200px"><span class="input-group-addon" ><i class="glyphicon glyphicon-search"></i></span>
   ...
   <br />
   <hr />
   <div id='formmau' class="form-control" style="height:50px">
        	Mã bộ môn <input type="text" id='mabm' >
            Tên bộ môn	<input type="text" id='tenbm'>
          
           <button class="btn btn-primary" id="addnew" >OK</button>
        	 <button class="btn btn-default" id="close" >Đóng</button>
             <div class="text-warning"></div>
</div>
     <div id="formmau2" class="form-control" style="height:50px">
                	Mã bộ môn <input type="text" id="maup" readonly/>

            		Tên bộ môn	<input type="text"  id="tenup" style="width:250px" />
          
           <button class="btn btn-primary" id="update" >OK</button>
        	 <button class="btn btn-default" id="cloupd" >Đóng</button><div class=" alert alert-success" style="width:200px; float:right; margin-right:150px;height:30px;padding:5px"></div>
   ...
   <hr />
	...
	<?php 
		...
		$result=mysql_query("select * from nganh", $cn);
		     echo"<tr><th style='width:30%'> Mã ngành</th><th style='width:30%'>Tên ngành</th><th style='width:10%'></th></tr>";

		while($row=mysql_fetch_array($result)){
				echo "<tr><td>".$row['MaNganh']."</td>";
				echo "<td>".$row['TenNganh']."</td>";
				echo "<td><button type='submit' class='btn btn-success' mabm=".$row['MaNganh']." value='".$row['TenNganh']."'><i class=' glyphicon glyphicon-pencil'style='color: white;'></i></button> <button type='submit' class='btn btn-danger' value=".$row['MaNganh']." id='del'><i class='glyphicon glyphicon-trash'></i></button></td></tr>";
