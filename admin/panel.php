...
<div class="content">
 ...
 <center><p style="color:#CCC; font-size:18px"> Chào, <?php echo $_SESSION["username"];?><br />
  ...
  <hr />
  <div class="active"><a href="panel.php" >Đơn đăng kí</a></div>
...
<button class="dropdown-btn"> Thống kê
  ...
  <div class="dropdown-container">
	...
	<p style="font-size:28px;color:#000; padding-left:140px;"> ĐƠN ĐĂNG KÍ</p>
    <div class="main">

	<div id="b"> <p style="float:left; margin-left:30px"><i class="glyphicon glyphicon-bell"></i>   Có <span style="color:red"> <?php $result=mysql_query(" select * from phieudk where Tinhtrang='chưa xét duyệt'", $cn);
		$total=mysql_num_rows($result);
		echo $total; ?></span> đăng kí mới</p>
  ...
  <input type="text" class="form-control" id='search' style="width:200px"><span class="input-group-addon" ><i class="glyphicon glyphicon-search"></i></span>
   ...
   <hr />
	...
	<?php 
		...
		$result=mysql_query("select MaDK, NgayDk, NgayMuon, Tinhtrang, MaSo from phieudk order by NgayDk DESC", $cn);
		...
		while($row=mysql_fetch_array($result)){
				...
				echo "<td>".$row['MaSo']."</td>";
				echo "<td><button type='submit'  class='btn btn-success' value=".$row['MaDK']."><i class=' glyphicon glyphicon-pencil'style='color: white;'></i></button></td></tr>";
