...
<div class="active" >   <a href="bomon.php">Bộ môn</a></div>
  </div>
...
</div>	<p style="font-size:28px;color:#000; padding-left:140px;"> BỘ MÔN</p>
    <div class="main">
  ...
  <input type="text" class="form-control" id='search' style="width:200px"><span class="input-group-addon" ><i class="glyphicon glyphicon-search"></i></span>
   ...
   <hr />
	...
	<?php 
		...
		$result=mysql_query("select * from bomon", $cn);
		...
		while($row=mysql_fetch_array($result)){
				...
				echo "<td><button type='submit' class='btn btn-success' mabm=".$row['MaBoMon']." value='".$row['TenBM']."'><i class=' glyphicon glyphicon-pencil'style='color: white;'></i></button> <button type='submit' class='btn btn-danger' value=".$row['MaBoMon']." id='del'><i class='glyphicon glyphicon-trash'></i></button></td></tr>";
